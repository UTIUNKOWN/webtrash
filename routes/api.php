...
// Route::post('monitoring',[DataController::class,'postEdge']);

// Route::get('monitoring',[DataController::class,'getEdge']);
// Route::post('monitoring',[DataController::class,'edgeGet']);
// Route::get('monitoring',[DataController::class,'edgeGet']);
