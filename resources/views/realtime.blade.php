            ...
            <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 d-flex justify-content-end">
                            <img src="/img/Icon-Sampah.png" class="img-fluid" alt="Responsive image" style="max-width: 200; height: auto;">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mx-auto">
                            <div class="card bg-warning" style="width: 25rem;">
                                <div class="w-2/4 flex-none">
                                    <div class="text-lg font-medium truncate text-center" style="color: rgb(28, 162, 189);">KAPASITAS</div>
                                    <div class="text-slate-500 mt-1 text-center" style="color: blue;">TEMPAT SAMPAH 1</div>
                                </div>
                        ...
                        <div class="col-6 mx-auto">
                            <div class="card" style="width: 25rem;">
                                <div class="w-2/4 flex-none">
                                    <div class="text-lg font-medium truncate text-center" style="color: black;">KAPASITAS</div>
                                    <div class="text-slate-500 mt-1 text-center" style="color: black;">TEMPAT SAMPAH 2</div>
                                </div>
                                <div class="flex-none ml-auto relative">
...
<script type="text/javascript">
    ...
    const COLORS = {
        KAPASITAS1: 'rgba(255, 165, 0, 0.8)',
        KAPASITAS2: 'rgba(0, 128, 255, 0.8)',
        SISA: 'rgba(200, 200, 200, 0.2)'
    };

    // Fungsi untuk menginisialisasi pie chart
    function initializePieChart(canvas, kapasitas, label) {
        ...
        var data = {
            ...
            datasets: [{
                data: [kapasitas, sisa],
                backgroundColor: [kapasitas > 100 ? 'rgba(255, 99, 71, 0.6)' : COLORS[label], COLORS.SISA],
            }]
        };
